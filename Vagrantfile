...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "client-a1" do |client_a1|
    ...
    # Install dependencies and define the NAT
    client_a1.vm.provision :shell, run: "always", path: "scripts/client.sh", :args => ["acfdd8113f1f4e1781d407eddfb7ef96","ba8d0ecc8f2140f184f20604c59f74ca", "10.0.0.1/24","xe0p8hnlRy5lTtucZcj-HA"]
  end
